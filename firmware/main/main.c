...
static inline esp_err_t make_request(char * path, char * action)
{
...
static inline esp_err_t cam_button(char * action)
{
    return make_request("/exec_shutter.cgi", action);
}
